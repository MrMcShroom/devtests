...
class sdShop
{
	...
	static init_class()
	{
		...
		if ( sdWorld.is_server )
		{
            ...
            sdShop.options.push({ _class: 'sdTurret', kind:sdTurret.KIND_AUTO_WELD, _category:'Base equipment', _min_build_tool_level: 20 });
			...
			//if ( globalThis.isWin ) // Lack of this check will probably allow creation of these entities even if category can not be opened in normal way
			{
				...
				sdShop.options.push({ _class: 'sdAsteroid', type:4, _category:'Development tests' });
